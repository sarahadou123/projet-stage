    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/Emplacement" element={<EquipemntEpla admineId={admineId}  data={data} setdata={setdata} dataadmine ={dataadmine}  activitesequip={activitesequip} setactivitesequip={setactivitesequip} />} />
