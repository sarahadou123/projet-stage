...
export default function ProfileUtili(){
  ...
  return(
    <div>
      <div className="headerProfilU">
        <div>
          <p className="P1headerUt">Bonjour <span>AbdLhamid</span> </p>
          <p className="P2headerUt">50 affectation</p>
        </div>
        <div className="butonoutP">
          <button className="BtnPROU">
            ...
            <div className="textPR">Logout </div>
          </button>
        </div>
      </div>
      <div className="containerProfileU">
        ...
        <div className="divformation">
          <p className="p1"> <span>Chaaoula</span> AbdLhamid</p>
          <p className="p3">Y789065</p>
          <p className="p3"> Nbr equipement affecter :50 </p>
